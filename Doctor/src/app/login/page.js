...
//       <div className="max-w-lg w-full bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden border border-white/20 relative z-10 p-10 text-center">
...
//           >
//             Continue to {role === "doctor" ? "Doctor" : "Admin"} Login
//           </button>
//         </form>
//       </div>
//     </div>
